...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/app/busquedaebay')) {
                // admin_app_busquedaebay_list
                if ($pathinfo === '/admin/app/busquedaebay/list') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'app.admin.busqueda_ebay',  '_sonata_name' => 'admin_app_busquedaebay_list',  '_route' => 'admin_app_busquedaebay_list',);
                }

                // admin_app_busquedaebay_create
                if ($pathinfo === '/admin/app/busquedaebay/create') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'app.admin.busqueda_ebay',  '_sonata_name' => 'admin_app_busquedaebay_create',  '_route' => 'admin_app_busquedaebay_create',);
                }

                // admin_app_busquedaebay_batch
                if ($pathinfo === '/admin/app/busquedaebay/batch') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'app.admin.busqueda_ebay',  '_sonata_name' => 'admin_app_busquedaebay_batch',  '_route' => 'admin_app_busquedaebay_batch',);
                }

                // admin_app_busquedaebay_edit
                if (preg_match('#^/admin/app/busquedaebay/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_busquedaebay_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'app.admin.busqueda_ebay',  '_sonata_name' => 'admin_app_busquedaebay_edit',));
                }

                // admin_app_busquedaebay_delete
                if (preg_match('#^/admin/app/busquedaebay/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_busquedaebay_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'app.admin.busqueda_ebay',  '_sonata_name' => 'admin_app_busquedaebay_delete',));
                }

                // admin_app_busquedaebay_show
                if (preg_match('#^/admin/app/busquedaebay/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_busquedaebay_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'app.admin.busqueda_ebay',  '_sonata_name' => 'admin_app_busquedaebay_show',));
                }

                // admin_app_busquedaebay_export
                if ($pathinfo === '/admin/app/busquedaebay/export') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'app.admin.busqueda_ebay',  '_sonata_name' => 'admin_app_busquedaebay_export',  '_route' => 'admin_app_busquedaebay_export',);
                }
